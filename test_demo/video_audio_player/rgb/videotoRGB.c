...
int main(int argc,char* argv[])
{
	...
	out_buffer=(uint8_t *)av_malloc(avpicture_get_size(PIX_FMT_RGB24, CONVERT_WITH, CONVERT_HIGH)); 	
	/*  将pFrameYUV和out_buffer联系起来（pFrame指向一段内存）；宏AV_PIX_FMT_YUV420P 代替宏PIX_FMT_YUV420P   */
	avpicture_fill((AVPicture *)pFrameYUV, out_buffer, PIX_FMT_RGB24, CONVERT_WITH, CONVERT_HIGH); 
